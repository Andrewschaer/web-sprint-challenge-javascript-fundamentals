...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const namesLowerCase = array.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const popLessThan5 = array.filter(function(item){
      return item.population < 5;
    });
    return popLessThan5;
  }
  
  console.log('T2R3', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(array){
    const totUSApop = array.reduce(function(accum, item){
      return accum + item.population;
    }, 0);
    return totUSApop;
  }
  
  console.log('T2R4', USApop(zooAnimals));
